      ...
      <div class="mt-12 ml-20 text-branco">
        ...
        <div class="flex-container mt-4 ml-6">
          <div class="row">
            ...
            <div id="quadrado" class="col-sm-6 col-md-4 col-lg-2 d-flex items-center justify-center ml-6 sm:rounded-lgg" style="background-color: #005A7C;">
              <a href="http://" class="text-decoration-none">
        ...
        <div class="flex-container mt-4">
          <div class="row">
            <div id="" class="col-sm-6 col-md-2 col-lg-2 d-flex items-center justify-center ml-6 rounded-lg bg-transparente">
            ...
            <div id="quadrado2" class="col-sm-6 col-md-2 col-lg-2 d-flex items-center justify-center ml-6 rounded-lg bg-transparente">
              <a href="" class="text-decoration-none">
              <br>
            ...
            <div id="quadrado2" class="col-sm-6 col-md-2 col-lg-2 d-flex items-center justify-center ml-6 rounded-lg bg-transparente">
              ...
              <div>
                <p class="text-branco d-flex justify-center text-xl">Gestão</p>
              </div>
              </a>
            </div>
